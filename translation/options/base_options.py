...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--loadSize', type=int, default=256, help='scale images to this size')#按此大小缩放图像
        self.parser.add_argument('--fineSize', type=int, default=256, help='then crop to this size')#裁剪到该尺寸
        ...
        self.parser.add_argument('--n_clusters', type=int, default=10, help='number of clusters for features') #特征集群的数量   
